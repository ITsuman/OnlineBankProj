 ...
 */
@WebServlet("/C_log")
public class C_log extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String sql="select account_number from customer where email=? and password=?";
			...
			{
				RequestDispatcher rd=request.getRequestDispatcher("C_log.jsp");
				rd.include(request, response);
